...
- **[results.md](results.md)** - what the pipeline currently achieves, the error budget,
...
- **[cadrille.md](cadrille.md)** - evaluating a published CAD-reconstruction model on
  these parts.
- `figures/` - renders referenced by the above.

`CLAUDE.md` at the repo root is the working guide: what the benchmark measures, the A/B
protocol, the ML method, and the environment traps.
